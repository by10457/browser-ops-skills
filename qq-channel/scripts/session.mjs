...
export async function bindingFor(root,value,options){return validateBinding(typeof value==='string'?(await readJSON(path.join(root,'config/qq-channel-bindings.json'))).bindings?.[value]:value,options);}
